...
def write_and_send3(i):
   ...
   # print("Ambient_t,Ambient_Hr",Ambient_t,Ambient_Hr)
    print("pH_",  read_PH()) 
    
   # print("flag_Ambient_t_Hr ",flag_Ambient_t_Hr)
   ...
   # print("flag_Ambient_t_Hr",flag_Ambient_t_Hr)
    ...
    try:
        ...
        if ((temperature2 > 0) and (flag_internal_Hr_t == True) and
        (flag_EC_TDS == True) and (flag_PH == True)):
            ...
            Ambient_t = internal_t - 9.76
            Ambient_Hr = internal_Hr + 15.4
            ...
            enviar=requests.get("https://api.thingspeak.com/update?api_key=3WLMTG6CBXPKOBK5&field1="+str(Ambient_t)+"&field2="+str(Ambient_Hr)
                        +"&field3="+str(temperature2)+"&field4="+str(internal_Hr)+"&field5="+str(ec)+"&field6="+str(ec_abs)+"&field7="
                        +str(TDS)+"&field8="+str(pH_))
            
            time.sleep(20)
            
            if flag_thingspeak == True:
                flag_thingspeak_ = 1
            else:
                flag_thingspeak_ = 0
            
            enviar2=requests.get("https://api.thingspeak.com/update?api_key=MN1FVC52YVLT9GV0&field1="+str(fecha_hora_formateada)+"&field2="+str(internal_t)+"&field3="+str(flag_thingspeak_))



        else:
             #  sirve para saber cuantas veces se ha intendado medir
            # con el dispositivo, si el contador llega a 5, debe enviar una alerta
            # de mal funcionamiento del dispositivo y reinicar dispositivo
            #for i in range(5):
             while (i<=5):   
                if  flag_thingspeak == True:
                    break
